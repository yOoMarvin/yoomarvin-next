export default function PrivacyPage() {
    return (
        <section className="prose dark:prose-invert prose-headings:mb-2 prose-headings:mt-0 prose-headings:font-bold prose-h1:text-3xl prose-a:font-normal prose-a:decoration-wavy prose-pre:border prose-pre:border-neutrals-100">
