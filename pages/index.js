        ...
        <div className='flex flex-col space-y-24'>
          <div className='flex flex-col space-y-8 md:items-center'>
            <PageHeader
              ...
              subtitle='I’m a product designer, podcaster, and writer, living in Mannheim, Germany. I’m currently helping founders and startups with UX design as an expert.'
            />

            <div className='flex flex-col space-y-2 md:space-x-4 md:flex-row md:space-y-0 md:items-center md:justify-center'>
              <Link href='/https://www.linkedin.com/in/marvin-messenzehl' passHref>
                <a>
